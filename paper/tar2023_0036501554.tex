...
\subsection{The direct underlying paper}
\section{Humicroedit data properties}
We can 

Annotator bias presents itself in topic frequency, as seen by one topic that appears in dataset entries more often than any other, at (TODO: add percentage) of the total dataset size.
...
Also, we can see at (TODO: Add chart for Trump distribution) that 
...
In this paper we shall use 5 different methods of determining how even is the label distribution: the Chi-Square Goodness-of-Fit test, the Kolmogorov-Smirnov test, the Shapiro-Wilk test, the Lilliefors test, and the Jarque-Bera Test.
